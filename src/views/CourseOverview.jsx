            ...
            <div className="flex-1 space-y-6">
              <div className="flex items-center space-x-3">
                ...
                <div className="flex items-center space-x-1">
                  ...
                  <span className="font-bold text-emerald-900 text-sm">4.9</span>
                  <span className="text-emerald-500 text-sm">(2.4k ratings)</span>
                </div>
              </div>
              ...
              <p className="text-lg text-emerald-700 max-w-2xl">
              ...
              <div className="flex flex-wrap items-center gap-6 text-sm text-emerald-600 font-medium">
                <div className="flex items-center space-x-2">
                  <Users className="w-5 h-5 text-emerald-400" />
                  <span>12,450 Learners</span>
                </div>
                <div className="flex items-center space-x-2">
                  <span className="w-5 h-5 flex items-center justify-center text-emerald-400 border border-emerald-400 rounded-full">🌐</span>
              ...
              <div className="flex items-center space-x-4 pt-4">
                ...
                <div>
                  <div className="text-xs text-emerald-500 font-bold uppercase tracking-wider">Created By</div>
                  <div className="font-bold text-emerald-900">Dr. Amina Kalu</div>
                </div>
              </div>
            </div>
          ...
          <div className="flex-1 space-y-16">
            ...
            <div>
              <div className="flex items-center space-x-3 mb-8">
                ...
                <h2 className="text-2xl font-bold text-emerald-900">What You Will Master</h2>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                {[
                  ...
                  <div key={idx} className="flex space-x-3 bg-emerald-50 p-4 rounded-xl border border-emerald-100">
                    ...
                    <span className="text-sm text-emerald-700 leading-relaxed">{item}</span>
                  </div>
                ))}
              </div>
            </div>
            ...
            <div>
              <div className="flex items-center justify-between mb-8">
                ...
                <div className="text-sm text-emerald-500">
                  <span className="font-bold text-emerald-900">14 Modules</span> • 128 lectures • 24h total length
                </div>
              </div>
              ...
              <div className="space-y-4">
                {curriculum.map((mod, idx) => (
                  <div key={idx} className="border border-emerald-200 rounded-xl overflow-hidden">
                    ...
                    >
                      <div>
                        <h4 className="font-bold text-emerald-900">{mod.title}</h4>
                        <div className="text-xs text-emerald-600 font-medium mt-1">{mod.lessons}</div>
                      </div>
                      {activeModule === idx ? <ChevronUp className="w-5 h-5 text-emerald-400" /> : <ChevronDown className="w-5 h-5 text-emerald-400" />}
                    </button>
            ...
            <div className="bg-emerald-50 rounded-2xl p-8 border border-emerald-100 flex flex-col sm:flex-row gap-8 items-start">
              ...
              <div>
                <h3 className="text-xl font-bold text-emerald-900">Dr. Amina Kalu</h3>
                <p className="text-emerald-700 font-medium text-sm mb-4">Chief Design Officer at TechSafari Africa</p>
                <div className="flex items-center space-x-6 text-sm text-emerald-600 mb-4">
                  <div className="flex items-center space-x-1">
                    <Star className="w-4 h-4 text-amber-400 fill-amber-400" />
                    <span className="font-bold text-emerald-900">4.9</span>
                    <span>Instructor Rating</span>
                  </div>
                  <div className="flex items-center space-x-1">
                    <Users className="w-4 h-4" />
                    <span className="font-bold text-emerald-900">85k</span>
                    <span>Students</span>
                  </div>
                  <div className="flex items-center space-x-1">
                ...
                <p className="text-emerald-600 text-sm leading-relaxed italic">
            ...
            {/* Testimonials */}
            <div>
              <h2 className="text-2xl font-bold text-emerald-900 mb-8">What our learners say</h2>
                ...
                {[1, 2, 3].map((i) => (
                  <div key={i} className="bg-white border border-emerald-200 rounded-xl p-6 shadow-sm">
                    <div className="flex items-center space-x-4 mb-4">
                      ...
                      <div>
                        <div className="font-bold text-emerald-900 text-sm">Kofi A.</div>
            ...
            <div>
              <div className="text-center mb-10">
                <h2 className="text-2xl font-bold text-emerald-900 mb-2">Frequently Asked Questions</h2>
                <p className="text-emerald-500">Everything you need to know about the course and the Uburiza platform.</p>
              </div>
              ...
              <div className="max-w-3xl mx-auto space-y-4">
                {['Is there a deadline to complete the course?', 'Can I download the videos for offline viewing?', 'Do I get a certificate after completion?'].map((q, idx) => (
                  <div key={idx} className="border border-emerald-200 rounded-xl bg-white">
                    <button 
                      className="w-full flex items-center justify-between p-5 text-left font-medium text-emerald-900"
                      onClick={() => setActiveFaq(activeFaq === idx ? null : idx)}
                    >
                      <span>{q}</span>
                      {activeFaq === idx ? <ChevronUp className="w-5 h-5 text-emerald-500" /> : <ChevronDown className="w-5 h-5 text-emerald-400" />}
                    </button>
                    {activeFaq === idx && (
                      <div className="p-5 pt-0 text-emerald-600 text-sm leading-relaxed border-t border-emerald-100">
          ...
          <div className="w-full lg:w-96 flex-shrink-0">
            <div className="sticky top-24 space-y-6">
              ...
              <div className="bg-white border border-emerald-200 rounded-2xl shadow-xl overflow-hidden">
                <div className="p-8 pb-6">
                  <div className="flex items-end space-x-3 mb-2">
                    <span className="text-4xl font-black text-emerald-900">$49.99</span>
                    <span className="text-lg text-emerald-400 line-through mb-1">$120.99</span>
                  ...
                  <div className="space-y-4">
                    <div className="text-sm font-bold text-emerald-900">This course includes:</div>
                ...
                <div className="bg-emerald-50 p-4 border-t border-emerald-100 flex items-center justify-between">
                  <div className="flex space-x-3">
                    <button className="text-emerald-400 hover:text-red-500 transition-colors">
                      <Heart className="w-5 h-5" />
                    </button>
                    <button className="text-emerald-400 hover:text-emerald-700 transition-colors">
              ...
              <div className="bg-emerald-50 border border-emerald-200 rounded-2xl p-6 flex items-start space-x-4">
                ...
                <div>
                  <h4 className="font-bold text-emerald-900 mb-1">30-Day Money-Back</h4>
                  <p className="text-xs text-emerald-500">Full refund if not satisfied.</p>
                </div>
              </div>
      ...
      <AnimatePresence>
        {showToast && (
          ...
          >
            ...
            <div>
              <p className="text-sm font-medium text-emerald-900">David from Lagos</p>
              <p className="text-xs text-emerald-500">Just enrolled in this course</p>
            </div>
          </motion.div>
        )}
      </AnimatePresence>
