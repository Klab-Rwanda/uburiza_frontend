  ...
  return (
    <div className="min-h-screen flex bg-gray-50 dark:bg-gray-900 transition-colors duration-300 font-sans">
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-8 sm:p-12 lg:p-24 relative order-1">
        ...
        >
          <div className="mb-10">
            <h2 className="text-3xl font-bold text-gray-900 dark:text-white mb-3">Create an account</h2>
            <p className="text-gray-500 dark:text-gray-400 text-sm">Join our community and start learning today.</p>
          </div>
          ...
          <div className="space-y-4">
            ...
            <div className="pt-2">
              <button 
                className="w-full bg-emerald-600 hover:bg-emerald-700 text-white font-bold py-3 rounded-xl transition-all shadow-lg shadow-emerald-200 dark:shadow-none flex items-center justify-center space-x-2 group"
          ...
          <div className="mt-8 flex items-center">
            ...
            <span className="px-4 text-xs text-gray-500 dark:text-gray-400 uppercase tracking-wider font-semibold">Or sign up with</span>
            <div className="flex-1 border-t border-gray-200 dark:border-gray-700"></div>
          </div>
