...
export default function AdminManagementForms() {
  return (
    <div className="page p-8 mx-auto space-y-12">
      {/* Header */}
      <div>
        <h1 className="text-2xl font-bold text-black mb-1">Admin Management</h1>
        <p className="text-sm text-black">Configure your courses and learning materials</p>
      </div>
      ...
      <div className="bg-white border border-emerald-200 rounded-2xl shadow-sm overflow-hidden">
        <div className="p-6 border-b border-emerald-200 flex justify-between items-center bg-emerald-50/50">
          <div>
            <h2 className="text-lg font-bold text-black">Create New Course</h2>
            <p className="text-sm text-black">Launch a new learning experience for your students.</p>
          </div>
          <div className="bg-emerald-100 text-black px-3 py-1 rounded text-xs font-semibold uppercase tracking-wider">
            Draft Mode
          </div>
        </div>
        ...
        <div className="p-6 space-y-6">
          <div className="grid grid-cols-2 gap-6">
            <div>
              <label className="block text-sm font-semibold text-black mb-1.5">Course Title</label>
          ...
          <div className="grid grid-cols-2 gap-6">
            <div>
              <label className="block text-sm font-semibold text-black mb-1.5">Level</label>
              <select className="w-full border border-emerald-300 rounded-lg px-4 py-2 text-sm focus:ring-2 focus:ring-blue-500 focus:outline-none bg-white">
                <option></option>
              </select>
            </div>
            <div className="flex items-center justify-between border border-emerald-300 rounded-lg px-4 py-2 bg-emerald-50">
              <div>
                <label className="block text-sm font-semibold text-black">Pricing Status</label>
                <p className="text-xs text-black">Course requires payment</p>
              </div>
          ...
          <div>
            <label className="block text-sm font-semibold text-black mb-1.5">Course Thumbnail</label>
            <div className="border-2 border-dashed border-emerald-300 rounded-xl p-8 flex flex-col items-center justify-center text-center hover:bg-emerald-50 transition-colors cursor-pointer bg-emerald-50/50">
              ...
              <p className="font-semibold text-black mb-1">Click or drag to upload cover image</p>
              <p className="text-xs text-black">Recommended size: 1200x675px (16:9)</p>
            </div>
          </div>

          <div>
            <label className="block text-sm font-semibold text-black mb-1.5">Course Description</label>
          ...
          <div>
            <label className="block text-sm font-semibold text-black mb-1.5">Intro Video URL (YouTube/Vimeo)</label>
            <div className="relative">
              <Video className="w-4 h-4 text-black absolute left-3 top-1/2 -translate-y-1/2" />
          ...
          <div>
            <div className="flex justify-between items-center mb-3">
              <label className="block text-sm font-semibold text-black flex items-center">
                Curriculum Builder <span className="ml-1 text-black cursor-help">ⓘ</span>
              </label>
              <button className="text-sm font-semibold text-black border border-emerald-300 px-3 py-1.5 rounded-lg hover:bg-emerald-50 flex items-center">
            ...
            <div className="border border-blue-200 rounded-xl bg-blue-50/30 overflow-hidden">
              <div className="p-4 flex items-center justify-between border-b border-blue-100 bg-white">
                <div className="flex items-center flex-1">
                  <GripVertical className="w-4 h-4 text-black mr-2 cursor-move" />
                  <span className="text-xs font-bold text-blue-600 uppercase tracking-wider mr-3">MODULE 1</span>
                  <input type="text" defaultValue="Introduction to UI/UX" className="font-semibold text-black bg-transparent border-none focus:outline-none flex-1 text-sm" />
                </div>
              ...
              <div className="p-4 space-y-2">
                <div className="flex items-center bg-white border border-emerald-200 rounded-lg p-3">
                  <GripVertical className="w-4 h-4 text-black mr-3 cursor-move" />
                  <span className="text-sm text-black mr-3">1.</span>
                  <span className="text-sm font-medium text-black flex-1">What is Design Thinking?</span>
                </div>
                <div className="flex items-center bg-white border border-emerald-200 rounded-lg p-3">
                  <GripVertical className="w-4 h-4 text-black mr-3 cursor-move" />
                  <span className="text-sm text-black mr-3">2.</span>
                  <span className="text-sm font-medium text-black flex-1">User Research Basics</span>
                </div>
                <button className="w-full mt-2 py-2 border border-dashed border-emerald-300 rounded-lg text-sm font-medium text-black hover:bg-white hover:border-emerald-400 transition-colors flex items-center justify-center">
        ...
        <div className="p-6 border-t border-emerald-200 bg-emerald-50 flex items-center space-x-4">
          ...
          <button className="bg-white border border-emerald-300 text-black px-6 py-2.5 rounded-lg text-sm font-semibold hover:bg-emerald-50 transition-colors shadow-sm">
            Save as Draft
          </button>
        </div>
      </div>
      ...
      <div className="bg-white border border-emerald-200 rounded-2xl shadow-sm overflow-hidden">
        <div className="p-6 border-b border-emerald-200 bg-emerald-50/50">
          <h2 className="text-lg font-bold text-black">Upload New Resource</h2>
          <p className="text-sm text-black">Add documents, slide decks, or assets to the global resource library.</p>
        </div>

        <div className="p-6 space-y-6">
          <div className="grid grid-cols-2 gap-6">
            <div>
              <label className="block text-sm font-semibold text-black mb-1.5">Resource Title</label>
          ...
          <div>
            <label className="block text-sm font-semibold text-black mb-1.5">Resource File</label>
            <div className="border-2 border-dashed border-purple-200 bg-purple-50/30 rounded-xl p-10 flex flex-col items-center justify-center text-center hover:bg-purple-50/60 transition-colors cursor-pointer">
              ...
              <p className="font-bold text-black mb-1 text-lg">Drop your file here</p>
              <p className="text-sm text-black mb-5">Supports PDF, PPTX, DOCX (Max 50MB)</p>
              <button className="bg-white border border-emerald-300 text-black px-6 py-2 rounded-lg text-sm font-semibold shadow-sm hover:bg-emerald-50">
                Choose File
              </button>
            </div>
          </div>
          ...
          <div>
            <label className="block text-sm font-semibold text-black mb-3">Visibility Settings</label>
            <div className="grid grid-cols-2 gap-4">
              <label className="border-2 border-blue-500 bg-blue-50/50 rounded-xl p-4 flex items-start space-x-3 cursor-pointer relative">
                ...
                <div>
                  ...
                  <p className="text-xs text-black">Visible to all enrolled students</p>
                </div>
              </label>
              <label className="border border-emerald-200 rounded-xl p-4 flex items-start space-x-3 cursor-pointer hover:bg-emerald-50 transition-colors">
                ...
                <div>
                  <div className="flex items-center font-bold text-black mb-1">
                    <Lock className="w-4 h-4 mr-2 text-black" /> Internal Only
                  </div>
                  <p className="text-xs text-black">Only visible to administrators</p>
                </div>
              </label>
            </div>
          </div>
        ...
        <div className="p-6 border-t border-emerald-200 bg-emerald-50 flex items-center space-x-4">
          ...
          <button className="bg-transparent text-black hover:text-gray-700 px-6 py-2.5 text-sm font-semibold transition-colors">
            Discard
          </button>
        </div>
      </div>
