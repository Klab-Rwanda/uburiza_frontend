      ...
      <div className="p-8 mx-auto space-y-8 flex-grow w-full relative z-10">
        ...
        <div className="flex justify-between items-center mb-12">
          <button 
            ...
            className="flex items-center text-emerald-500 hover:text-emerald-700 transition-colors font-medium text-sm"
          >
            <ChevronLeft className="w-4 h-4 mr-1" />
            Back to Dashboard
          </button>
          
          <div className="flex items-center text-xs font-semibold text-emerald-700 bg-white border border-emerald-200 px-3 py-1.5 rounded-full shadow-sm">
        ...
        <div className="bg-white p-2 rounded-2xl shadow-2xl mx-auto max-w-4xl transform hover:scale-[1.01] transition-transform duration-300">
          <div className="border-4 border-[#1e4c31] rounded-xl p-12 text-center relative overflow-hidden bg-[url('data:image/svg+xml;base64,PHN2ZyB4bWxucz0iaHR0cDovL3d3dy53My5vcmcvMjAwMC9zdmciIHdpZHRoPSI0IiBoZWlnaHQ9IjQiPgo8cmVjdCB3aWR0aD0iNCIgaGVpZ2h0PSI0IiBmaWxsPSIjZmZmIj48L3JlY3Q+CjxyZWN0IHdpZHRoPSIxIiBoZWlnaHQ9IjEiIGZpbGw9IiNlNThjZDYiIG9wYWNpdHk9IjAuMSI+PC9yZWN0Pgo8L3N2Zz4=')]">
            ...
            <h3 className="text-emerald-500 tracking-[0.2em] font-bold text-sm uppercase mb-12">
              Certificate of Completion
            </h3>
            
            <p className="text-emerald-500 italic mb-4">This is to certify that</p>
            <h2 className="text-5xl font-bold text-[#1e4c31] mb-8">Abebe Bikila</h2>
            
            <p className="text-emerald-600 mb-4">has successfully completed the course</p>
            <h1 className="text-3xl font-bold text-emerald-900 mb-8 max-w-2xl mx-auto leading-tight">
              Advanced Entrepreneurship & Digital Strategy
            </h1>
            
            <p className="text-emerald-500 max-w-xl mx-auto mb-16">
            ...
            <div className="border-t border-emerald-200 pt-8 flex justify-between items-end text-left px-8">
              <div>
                ...
                <p className="text-xs text-emerald-500">ID: UB-2024-8842-XF92</p>
                <p className="text-xs text-emerald-500">Issued on: October 24, 2024</p>
              </div>
              ...
              <div className="flex flex-col items-center">
                ...
                <span className="text-[10px] font-bold text-emerald-500 tracking-wider">SCAN TO VERIFY</span>
              </div>
        ...
        <div className="flex justify-center items-center space-x-4 mt-8">
          ...
          <button className="bg-white border border-emerald-500 text-emerald-600 hover:bg-emerald-50 px-6 py-3 rounded-lg font-medium flex items-center transition-colors shadow-sm">
          ...
          <div className="flex items-center space-x-3 ml-4 border-l border-emerald-200 pl-4">
            <button className="w-10 h-10 rounded-full border border-emerald-200 flex items-center justify-center text-emerald-500 hover:text-blue-400 hover:border-blue-400 transition-colors">
              <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24"><path d="M24 4.557c-.883.392-1.832.656-2.828.775 1.017-.609 1.798-1.574 2.165-2.724-.951.564-2.005.974-3.127 1.195-.897-.957-2.178-1.555-3.594-1.555-3.179 0-5.515 2.966-4.797 6.045-4.091-.205-7.719-2.165-10.148-5.144-1.29 2.213-.669 5.108 1.523 6.574-.806-.026-1.566-.247-2.229-.616-.054 2.281 1.581 4.415 3.949 4.89-.693.188-1.452.232-2.224.084.626 1.956 2.444 3.379 4.6 3.419-2.07 1.623-4.678 2.348-7.29 2.04 2.179 1.397 4.768 2.212 7.548 2.212 9.142 0 14.307-7.721 13.995-14.646.962-.695 1.797-1.562 2.457-2.549z"/></svg>
            </button>
            <button className="w-10 h-10 rounded-full border border-emerald-200 flex items-center justify-center text-emerald-500 hover:text-blue-600 hover:border-blue-600 transition-colors">
              <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24"><path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.469h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.469h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/></svg>
            </button>
            <button className="w-10 h-10 rounded-full border border-emerald-200 flex items-center justify-center text-emerald-500 hover:text-emerald-900 hover:border-emerald-900 transition-colors">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-16 pb-16">
          <div className="bg-white border border-emerald-200 rounded-2xl p-6 shadow-sm hover:shadow-md transition-shadow">
            ...
            <h4 className="font-bold text-emerald-900 mb-2">BlockChain Verified</h4>
          ...
          <div className="bg-white border border-emerald-200 rounded-2xl p-6 shadow-sm hover:shadow-md transition-shadow">
            ...
            <h4 className="font-bold text-emerald-900 mb-2">Public Profile</h4>
            <p className="text-sm text-emerald-500 leading-relaxed">
          ...
          <div className="bg-white border border-emerald-200 rounded-2xl p-6 shadow-sm hover:shadow-md transition-shadow">
            ...
            <h4 className="font-bold text-emerald-900 mb-2">Skill Points</h4>
            <p className="text-sm text-emerald-500 leading-relaxed">
