    ...
    <header className="bg-white border-b border-emerald-200 h-16 flex items-center justify-between px-8 sticky top-0 z-50 transition-colors duration-300">
      <div className="flex items-center space-x-12">
        ...
        <nav className="hidden md:flex space-x-6 text-sm font-medium">
          <button onClick={() => setView('CourseCatalog')} className="text-emerald-500 hover:text-emerald-800 transition-colors">Courses</button>
          <button onClick={() => setView('Resources')} className="text-emerald-500 hover:text-emerald-800 transition-colors">Resources</button>
        </nav>
      </div>
      ...
      <div className="flex items-center space-x-6">
        ...
        <div className="flex items-center space-x-4 border-l border-emerald-200 pl-6">
          <button className="text-sm font-medium text-emerald-600 hover:text-emerald-900 transition-colors ml-2" onClick={() => setView('Login')}>Login</button>
